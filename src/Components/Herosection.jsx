    ...
    <div className="bg-[#0F5265] text-white px-6 sm:px-10 md:px-16 lg:px-20 py-12 lg:py-16 min-h-screen">
      <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-16">
        ...
        <div className="max-w-full lg:max-w-xl space-y-4 sm:space-y-6">
          ...
          <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6 text-white">
            <div className="text-yellow-500 text-2xl sm:text-3xl">
              <img src={light} alt="" className="w-20 sm:w-28 -ml-4 sm:-ml-5 -mt-1 sm:-mt-2"/>
            </div>
            <div>
              <h3 className="font-semibold text-base sm:text-lg -ml-4 sm:-ml-6 mt-2">
                Sales Cycle Trained
              </h3>
              <p className="-ml-4 sm:-ml-6 text-sm sm:text-base">
                Never miss a potential client, and convert leads into loyal clintele with a 
                seamlessly guided sales journey.
              </p>
              <img src={scroll} alt="" className="mt-2 sm:mt-4 -ml-4 sm:-ml-6 w-20 sm:w-24"/>
            </div>
          </div>

          <button className="mt-4 sm:mt-6 bg-gradient-to-r from-[#F5D794] via-white to-[#F5D794] 
        ...
        {/* Right Side */}
        <div className='flex flex-col lg:flex-row bg-[#E8E8E8] w-full sm:w-[480px] md:w-[520px] lg:w-[560px] 
          h-auto sm:h-[500px] md:h-[560px] lg:h-[600px] gap-6 lg:gap-8 -mt-12 sm:-mt-16 lg:-mt-24 -mr-0 lg:-mr-10 rounded-3xl items-center justify-center px-4 py-6'>
